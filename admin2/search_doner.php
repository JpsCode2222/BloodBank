                                        ...
                                        <form  method="GET">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                if($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['go'])){
                                                        include('conn.php');
                                                        $data=$_GET['data'];
                                                        $q="SELECT * FROM doner_list WHERE doner_name='$data' OR blood_group='$data' OR doner_id='$data'";
                                                    $res=mysqli_query($conn,$q);
                                                    $i=1;
                                                    while($row=mysqli_fetch_assoc($res)){
                                                        echo "<tr><td>".$i."</td>";
                                                        echo "<td class='text-light bg-success text-center'>".$row['doner_id']."</td>";
