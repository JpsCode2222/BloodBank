            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Print Cirtificate : </h3>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <tbody>
                                                     ...
                                                     if(isset($_GET['go'])=="Go"){
                                                      if($_SERVER['REQUEST_METHOD'] == "GET"){
                                                          ...
                                                          while($row=mysqli_fetch_assoc($res)){
                                                              ...
                                                              echo "<td><a href='cirtificate_print.php?id=".$row['doner_id']."'> <button class='btn btn-primary btn-sm mr-2'>Certificate</button></a></td></tr>";
                                                              $i++;
                                                          }
                                                  ...
                                                  while($row=mysqli_fetch_assoc($res)){
                                                      ...
                                                      echo "<td>".$row['address']."</td>";
                                                      echo "<td>".$row['blood_group']."</td>";
                                                      echo "<td><a href='save_print_cirtificate.php?id=".$row['doner_id']."'> <button class='btn btn-primary btn-sm mr-2'>Certificate</button></a></td></tr>";
                                                      $i++;
                                                  }
                                              }
                                              ?>
